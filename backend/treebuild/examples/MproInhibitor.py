...
input_file = "./Mpro_inhibition_result_20201224_withSMILES_cleaned.txt"
out_file = "./Mpro_inhibition_result_20201224_withSMILES_cleaned.json"
properties = {"activities": [pic50], "properties": DEFAULT_PROPERTY_TYPES, "ext_links": []}
treebuild.TreeBuild(input_file, out_file, id_column="compoundID", fps=DEFAULT_FINGERPRINT_TYPES, properties=properties)
...
for fname in ["./Mpro_inhibition_result_20201224_withSMILES_cleaned.json", "./factorxa.json", "./cdk2.json", "./map_p38.json", "./cyto.json"]:
    try:
